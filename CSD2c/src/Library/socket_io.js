    ...
    ({1:[function(_dereq_,module,exports) {
        ...
        function coerce(val) {
            ...
            return arr
                ...
                return _hasBinary(data)
                                         ...
                                         try{module.exports=typeof XMLHttpRequest!=="undefined"&&"withCredentials"in new XMLHttpRequest} catch(err) {
        ...
        exports.decode=function(qs) {
            ...
            return qry
                                         ...
                                         var re=/^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9] {0,4}:) {
                                             2,7
        }[a-f0-9] {0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;
